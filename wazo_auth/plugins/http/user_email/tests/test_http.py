...
class TestUserEmailConfirmResource(HTTPAppTestCase):
    ...
    def test_unknown_user(self):
        self.user_service.get_user.side_effect = exceptions.UnknownUserException(UNKNOWN_UUID)
    ...
    def test_get(self):
        ...
        self.email_service.send_confirmation_email.assert_called_once_with(*expected_args)
