"""add user list conference participants ACL

Revision ID: 9d5a70a8fcd0
Revises: 2ff1ec9abf64
...
revision = '9d5a70a8fcd0'
down_revision = '2ff1ec9abf64'

POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['calld.users.me.conferences.*.participants.read']
