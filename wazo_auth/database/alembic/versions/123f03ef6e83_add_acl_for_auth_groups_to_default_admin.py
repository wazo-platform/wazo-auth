"""add ACL for auth groups to default_admin

Revision ID: 123f03ef6e83
Revises: b17ac2c5b6c7
...
revision = '123f03ef6e83'
down_revision = 'b17ac2c5b6c7'

POLICY_NAME = 'wazo_default_admin_policy'
ACL_TEMPLATES = ['auth.groups.#']
