"""add dird backends read acl to admins

Revision ID: 2a47261b2c2d
Revises: 64b7366566f1
...
revision = '2a47261b2c2d'
down_revision = '64b7366566f1'


POLICY_NAME = 'wazo_default_admin_policy'
ACL_TEMPLATES = ['dird.backends.read']
