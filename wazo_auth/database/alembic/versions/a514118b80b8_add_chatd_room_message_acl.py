"""add_chatd_room_message_acl

Revision ID: a514118b80b8
Revises: 0d9094f11fb5
...
revision = 'a514118b80b8'
down_revision = '0d9094f11fb5'


POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['chatd.users.me.rooms.#', 'events.chatd.users.me.rooms.#']
