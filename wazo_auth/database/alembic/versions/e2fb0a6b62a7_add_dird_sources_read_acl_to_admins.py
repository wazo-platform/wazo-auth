"""add dird sources read acl to admins

Revision ID: e2fb0a6b62a7
Revises: 2214965a2f9e
...
revision = 'e2fb0a6b62a7'
down_revision = '2214965a2f9e'


POLICY_NAME = 'wazo_default_admin_policy'
ACL_TEMPLATES = ['dird.sources.read']
