"""add_wazo_user_acl_to_root

Revision ID: 9e376c1e7473
Revises: d5459a0ced9d
...
revision = '9e376c1e7473'
down_revision = 'd5459a0ced9d'

POLICY_NAME = 'wazo_default_admin_policy'
ACL_TEMPLATES = ['auth.users.#', 'auth.admin.#']
