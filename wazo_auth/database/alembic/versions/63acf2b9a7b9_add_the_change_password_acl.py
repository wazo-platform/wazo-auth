"""add the change password ACL

Revision ID: 63acf2b9a7b9
Revises: 123f03ef6e83
...
revision = '63acf2b9a7b9'
down_revision = '123f03ef6e83'

POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['auth.users.{{ uuid }}.password.edit']
