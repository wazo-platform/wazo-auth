"""add external auth config right to admins

Revision ID: 5c7d44ebeedc
Revises: c62c91eb4824
...
revision = '5c7d44ebeedc'
down_revision = 'c62c91eb4824'

POLICY_NAME = 'wazo_default_admin_policy'
ACL_TEMPLATES = ['auth.*.external.*']
