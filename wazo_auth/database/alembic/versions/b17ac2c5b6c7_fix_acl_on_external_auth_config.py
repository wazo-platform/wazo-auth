"""fix acl on external auth config

Revision ID: b17ac2c5b6c7
Revises: 9d5a70a8fcd0
...
revision = 'b17ac2c5b6c7'
down_revision = '9d5a70a8fcd0'

POLICY_NAME = 'wazo_default_admin_policy'
ACL_TEMPLATES = ['auth.*.external.config.*']
