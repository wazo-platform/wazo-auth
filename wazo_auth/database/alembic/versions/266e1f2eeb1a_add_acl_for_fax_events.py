"""add ACL for fax events

Revision ID: 266e1f2eeb1a
Revises: 091cb7a596e2
...
revision = '266e1f2eeb1a'
down_revision = '091cb7a596e2'


POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['events.faxes.outbound.users.me.*']
