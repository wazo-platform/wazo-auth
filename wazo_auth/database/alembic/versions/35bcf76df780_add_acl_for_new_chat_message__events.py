"""add ACL for new chat_message_* events

Revision ID: 35bcf76df780
Revises: 192f49b6ec34
...
revision = '35bcf76df780'
down_revision = '192f49b6ec34'


POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['events.chat.message.*.me.*']
