"""add dird configuration ACL

Revision ID: 14722ead9b59
Revises: 4d994bfa20e0
...
revision = '14722ead9b59'
down_revision = '4d994bfa20e0'

POLICY_NAME = 'wazo_default_admin_policy'
ACL_TEMPLATES = [
    'dird.backends.*.sources.#',
    'dird.displays.#' 'dird.profiles.#' 'dird.sources.read',
]
