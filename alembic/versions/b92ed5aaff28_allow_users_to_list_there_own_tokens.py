"""allow users to list there own tokens

Revision ID: b92ed5aaff28
Revises: e562aa789af5
...
revision = 'b92ed5aaff28'
down_revision = 'e562aa789af5'

POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['auth.users.{{ user_uuid }}.tokens.read', 'auth.users.me.tokens.read']
