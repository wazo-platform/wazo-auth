"""add dird office365 backend acl

Revision ID: 0d9094f11fb5
Revises: 266e1f2eeb1a
...
revision = '0d9094f11fb5'
down_revision = '266e1f2eeb1a'


POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['dird.backends.office365.sources.*.contacts.read']
