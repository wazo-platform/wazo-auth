"""add dird.directories.lookup.*.sources.read to users

Revision ID: 64b7366566f1
Revises: 14722ead9b59
...
revision = '64b7366566f1'
down_revision = '14722ead9b59'


POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['dird.directories.*.sources.read']
