"""add the ACL to list user in sources for users

Revision ID: 2214965a2f9e
Revises: 2a47261b2c2d
...
revision = '2214965a2f9e'
down_revision = '2a47261b2c2d'

POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['dird.backends.*.sources.*.contacts.read']
