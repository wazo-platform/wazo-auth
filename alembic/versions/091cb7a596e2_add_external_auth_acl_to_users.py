"""add external auth acl to users

Revision ID: 091cb7a596e2
Revises: 9ced172c67a9
...
revision = '091cb7a596e2'
down_revision = '9ced172c67a9'

POLICY_NAME = 'wazo_default_user_policy'
ACL_TEMPLATES = ['auth.users.{{ uuid }}.external.#']
