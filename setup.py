...
setup(
    ...
    entry_points={
        ...
        'wazo_auth.http': [
            'groups = wazo_auth.plugins.http.groups.groups:Plugin',
            'policies = wazo_auth.plugins.http.policies.policies:Plugin',
            'tenants = wazo_auth.plugins.http.tenants.tenants:Plugin',
            'tenant_user = wazo_auth.plugins.http.tenant_user.tenant_user:Plugin',
            'users = wazo_auth.plugins.http.users.users:Plugin',
            'user_group = wazo_auth.plugins.http.user_group.user_group:Plugin',
            'user_policy = wazo_auth.plugins.http.user_policy.user_policy:Plugin',
        ],
        'wazo_auth.backends': [
